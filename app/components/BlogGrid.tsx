...
// export default function BlogGrid({refetchOnWindowFocus=false}) {
...
//       <h2 className="text-2xl sm:text-3xl font-bold text-black">Flash Feed </h2>
//     </div>
//     <Link
//       href="/feeds"
...
//     <div className="flex items-center gap-3">
//       <TrendingUp className="w-6 h-6 text-black" />
//       <h2 className="text-2xl sm:text-3xl font-bold text-black">Deep Reads </h2>
//     </div>
//     <Link
//       href="/reads"
//       className="text-sm font-medium text-gray-600 hover:text-black transition-colors"
...
// import { Clock, TrendingUp } from 'lucide-react';
// import { BLOGS as INITIAL_BLOGS } from '../lib/data';
// import { BLOG_QUERY_KEY } from '@/lib/useBlog';
...
// export default function BlogGrid({blogs, isLoading, error}: BlogGridProps) {
// const queryClient = useQueryClient(); // ← GET IT HERE
...
//     };
//     window.addEventListener('blogPublished', handler);
//     return () => window.removeEventListener('blogPublished', handler);
//   }, [queryClient]);
